...
class roles(models.Model):
    ...
    roles_status=models.CharField(max_length=20,choices=ROLES_CHOICES)
...
class user_status(models.Model):
    ...
    status=models.CharField(max_length=20,choices=USER_CHOICES)
    def _str_(self):
        return self.status
...
class Contact_Status(models.Model):
    ...
    status=models.CharField(max_length=20,choices=CONTACT_CHOICES)
    def _str_(self):
        return self.status
